$(function () {
    ...
    var currMonth = ((d.getMonth() + 1)>9 ? (d.getMonth() + 1) :'0'+(d.getMonth() + 1));
    var currDate = d.getDate()>9 ? d.getDate() : '0'+d.getDate();
    ...
    $(".reback").eq(0).click(function () {
        ...
        getSelectDate(currYear + " - " + currMonth + " - " + d.getDate()>9 ? d.getDate() : '0'+d.getDate())
    });
    var currN = 0;
    var currK = 0;
    ergodicDate(currYear, currMonth);
    ...
    $(".day-tabel").on("click", ".tabel-li", function (e) {
        ...
        if (parentIndex == 0 && $(this).html() > 7) {
            ...
            if (($("#monthList").val().split("月")[0] - 1) > 0) {
                selectDate = $("#yearList").val().split("年")[0] + " - " + ($("#monthList").val().split("月")[0] - 1) + " - " + ($(this).html()>9?(this).html():'0'+$(this).html());
                ...
                selectDate = ($("#yearList").val().split("年")[0] - 1) + " - " + 12 + " - " + ($(this).html()>9?(this).html():'0'+$(this).html());
            ...
            if (parentIndex == currK && $(this).html() < 7) {
                if (parseInt($("#monthList").val().split("月")[0]) + 1 > 12) {
                    selectDate = (parseInt($("#yearList").val().split("年")[0]) + 1) + " - " + 1 + " - " + ($(this).html()>9?(this).html():'0'+$(this).html());
                    ergodicDate($("#yearList").val().split("年")[0], ($("#monthList").val().split("月")[0] - 1));
                    $("#yearList").val((parseInt($("#yearList").val().split("年")[0]) + 1) + "年");
                    $("#monthList").val(1 + "月")
                } else {
                    selectDate = ($("#yearList").val().split("年")[0]) + " - " + (parseInt($("#monthList").val().split("月")[0]) + 1) + " - " + ($(this).html()>9?(this).html():'0'+$(this).html());
                    ergodicDate(($("#yearList").val().split("年")[0]), (parseInt($("#monthList").val().split("月")[0]) + 1));
                    $("#yearList").val(($("#yearList").val().split("年")[0]) + "年");
                    $("#monthList").val((parseInt($("#monthList").val().split("月")[0]) + 1) + "月")
                }
            } else {
                selectDate = $("#yearList").val().split("年")[0] + " - " + $("#monthList").val().split("月")[0] + " - " + ($(this).html()>9?(this).html():'0'+$(this).html())
            }
        }
        ...
        var getDate = $("#yearList").val().split("年")[0] + " - " + $("#monthList").val().split("月")[0] + " - " + ($(this).html()>9?(this).html():'0'+$(this).html());
